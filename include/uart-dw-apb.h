#ifndef _UART_DW_APB_H_
#define _UART_DW_APB_H_
...
#define LPDLL           0x0020  // Low Power Divisor Latch low
#define LPDLH           0x0024  // Low Power Divisor Latch high
#define SRBRn(num)      (0x0030+num*4) //shadow receive buffer register
#define STBRn(num)		(0x0030+num*4) //shadow transmit holding register
#define FAR				0x0070  // FIFO access register
#define TFR				0x0074	// Transmit FIFO READ
#define RFW				0x0078  // Receive FIFI Write
...
#define UART_HSK        0x0088  // DMA Handshake Configuration Register  //diff
#define UART_DMA_REQ_EN 0x008c  // DMA Request Enable Register //diff
#define UART_HALT       0x00a4  // Halt TX Register
#define UART_DBG_DLL    0x00b0  // Debug DLL Register //diff
#define UART_DBG_DLH    0x00b4  // Debug DLH Register //diff
#define UART_A_FCC      0x00f0  // FIFO Clock Control Register

#endif // ifndef _UART_DW_APB_H_
